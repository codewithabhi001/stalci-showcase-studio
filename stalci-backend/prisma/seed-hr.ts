...
export async function seedHRData() {
  ...
  const employeesData = [
    ...
    {
      employeeCode: 'ST-EMP-007',
      name: 'Maya Patel',
      email: 'maya.patel@stalci.com',
      personalEmail: 'maya.patel@mit.edu',
      phone: '+1 (617) 555-7721',
      avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150',
      departmentId: depts['SRE-OPS'].id,
      designation: 'Kernel Isolation Research Fellow',
      joiningDate: new Date('2026-06-01'),
      employmentType: 'Intern',
      workLocation: 'Boston, MA / Remote',
      status: 'ACTIVE',
      salaryCtc: 54000,
      bankName: 'Fidelity',
      bankAccount: '••••••••4419',
      ...
      emergencyContactPhone: '+1 (617) 555-9922',
      skills: JSON.stringify(['Rust', 'C++', 'Linux Kernel', 'KVM', 'eBPF']),
      notes: 'Focusing on zero-trust confidential compute Isolation.',
      probationStatus: 'PENDING',
      probationEndDate: new Date('2026-09-01'),
    },
    {
      employeeCode: 'ST-EMP-008',
      name: 'Lucas Vance',
      email: 'lucas.vance@stalci.com',
      personalEmail: 'lucas.vance@cmu.edu',
      phone: '+1 (412) 555-3319',
      avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150',
      departmentId: depts['ENG-FE'].id,
      designation: 'WebGL Systems Engineer Intern',
      joiningDate: new Date('2026-04-01'),
      employmentType: 'Intern',
      workLocation: 'Pittsburgh, PA / Hybrid',
      status: 'COMPLETED',
      salaryCtc: 45000,
      bankName: 'PNC Bank',
      bankAccount: '••••••••8821',
      ...
      emergencyContactPhone: '+1 (412) 555-4411',
      skills: JSON.stringify(['WebGL', 'Three.js', 'React', 'TypeScript', 'Shader Programming']),
      notes: 'Completed spring fellowship on real-time rendering.',
      probationStatus: 'CONFIRMED',
    },
  ];
  ...
  await prisma.internshipRecord.upsert({
    where: { employeeId: emps['ST-EMP-007'].id },
    update: {},
    create: {
      employeeId: emps['ST-EMP-007'].id,
      institute: 'MIT EECS Laboratory',
      mentorName: 'Dr. Marcus Vance',
      projectTitle: 'Zero-Trust Distributed Kernel Isolation & micro-VM Orchestration',
      stipend: 4500,
      startDate: new Date('2026-06-01'),
      endDate: new Date('2026-09-01'),
      status: 'ACTIVE',
      certificateIssued: true,
      performanceNotes: 'Pioneered low-latency memory page isolation for confidential AI compute nodes.',
    },
  });

  await prisma.internshipRecord.upsert({
    where: { employeeId: emps['ST-EMP-008'].id },
    update: {},
    create: {
      employeeId: emps['ST-EMP-008'].id,
      institute: 'Carnegie Mellon University (Robotics Institute)',
      mentorName: 'Sophia Chen',
      projectTitle: 'Real-Time WebGL Telemetry & Multi-Tenant Analytics Visualizer',
      stipend: 3800,
      startDate: new Date('2026-04-01'),
      endDate: new Date('2026-07-01'),
      status: 'COMPLETED',
      certificateIssued: true,
      performanceNotes: 'Delivered high-performance GPU-accelerated rendering components.',
    },
  });
