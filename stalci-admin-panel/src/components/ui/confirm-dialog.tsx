...
export function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-4 no-print">
      <div className="animate-fade-in absolute inset-0 bg-black/40 backdrop-blur-md" onClick={handleClose} />
      <div
        role="alertdialog"
        aria-modal="true"
      ...
      >
        <span className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-red-500/15 text-red-600 border border-red-500/30">
