...
export default function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-canvas relative overflow-hidden selection:bg-copper/20 selection:text-copper-soft">
      ...
      <div className="relative hidden flex-col justify-between p-12 lg:flex bg-surface/90 border-r border-line backdrop-blur-xl z-10">
        <div className="relative flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[9.5px] text-copper-deep block uppercase font-mono font-bold tracking-widest">
        ...
        <div className="relative max-w-md space-y-4">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-copper/15 px-3 py-1 text-[11px] font-bold text-copper-deep border border-copper/35 font-mono shadow-[0_0_15px_rgba(216,155,91,0.2)]">
            <Sparkles className="h-3 w-3 text-copper animate-pulse" /> Portfolio Showcase OS
          </span>
          <h2 className="text-[34px] font-bold leading-[1.15] tracking-tight text-ink font-display">
      ...
      <div className="flex items-center justify-center bg-canvas/80 px-5 py-14 relative z-10 backdrop-blur-md">
        <form
          ...
          className="card w-full max-w-[420px] p-8 sm:p-9 border border-line bg-surface/90 shadow-card backdrop-blur-xl rounded-3xl space-y-5 relative"
        >
          ...
          <div className="p-3 rounded-2xl bg-copper/10 border border-copper/30 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 text-xs text-copper-deep">
            ...
            <button
              type="button"
              onClick={fillDemo}
              className="shrink-0 text-[11px] font-bold text-white bg-copper hover:bg-copper-deep px-2.5 py-1 rounded-lg transition-colors font-mono cursor-pointer"
            >
              Fill Demo
            </button>
          </div>
          ...
          {error && (
            <div role="alert" className="rounded-xl border border-red-500/30 bg-red-500/15 px-3.5 py-2.5 text-[12.5px] text-red-700 font-medium animate-pop">
              {error}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-faint hover:text-ink transition-colors cursor-pointer"
                >
