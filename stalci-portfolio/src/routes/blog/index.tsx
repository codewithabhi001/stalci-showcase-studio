          ...
          {featured && (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-extrabold uppercase tracking-[0.2em] text-emerald-600 bg-zinc-100 border border-zinc-200 px-3 py-1 rounded-full">
              ...
              <div className="mt-6 pt-5 border-t border-zinc-100 flex flex-wrap items-center justify-between gap-4">
                <span className="text-xs font-semibold text-zinc-700 flex items-center gap-1.5">
                  <User className="h-3.5 w-3.5 text-emerald-600" /> {featured.author}
                </span>
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-emerald-600 bg-zinc-100 px-2.5 py-0.5 rounded-full border border-zinc-200">
                      {p.category}
                    </span>
