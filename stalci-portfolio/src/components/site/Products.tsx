...
export function Products() {
  return (
    <section id="products" className="border-t border-zinc-200/90 bg-[#FFFFFF] py-14 sm:py-20 text-black relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid gap-6 lg:grid-cols-2 max-w-5xl mx-auto items-stretch">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-zinc-200/90 shadow-2xs bg-zinc-100">
                <img
                  src="/images/products/ai_studio.jpg"
                  alt="Stalci AI Studio"
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-zinc-950 tracking-tight leading-snug">
                  Stalci AI Studio &bull; Private LLM Pipeline
                </h3>
                <p className="mt-1.5 text-xs sm:text-[13px] leading-relaxed text-zinc-600 font-normal">
                  Fine-tune, evaluate, and orchestrate private domain agents within isolated VPC enclaves with zero data retention and sub-15ms semantic retrieval.
                </p>
              </div>
            ...
            <div className="mt-6 pt-4 border-t border-zinc-200/80 flex items-center justify-between">
              <span className="text-xs font-mono font-bold text-zinc-950">
                Benchmark: <strong className="text-black">&lt; 18ms TTFT</strong>
              </span>

              <Link
                to="/products/"
                params={{ slug: "stalci-ai-studio" }}
          ...
          {/* Accelerator 2: StalciOps Autonomous Cloud Fabric */}
          <motion.div
            initial={{ opacity: 0, y: 15 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="space-y-4">
              ...
              <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-zinc-200/90 shadow-2xs bg-zinc-100">
                <img
                  src="/images/products/stalci_ops.jpg"
                  alt="StalciOps Autonomous Cloud Fabric"
                  className="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-500 ease-out"
                />
                <div className="absolute top-3 left-3 bg-black/80 backdrop-blur-md text-white text-[10px] font-mono font-bold uppercase tracking-wider px-2.5 py-1 rounded-full border border-white/20">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-zinc-950 tracking-tight leading-snug">
                  StalciOps &bull; Autonomous Cloud Fabric
                </h3>
                <p className="mt-1.5 text-xs sm:text-[13px] leading-relaxed text-zinc-600 font-normal">
                  Multi-cloud cost governance, automated Kubernetes container right-sizing, and zero-trust IAM policy automation.
                </p>
              </div>
            ...
            <div className="mt-6 pt-4 border-t border-zinc-200/80 flex items-center justify-between">
              <span className="text-xs font-mono font-bold text-zinc-950">
                Benchmark: <strong className="text-black">-38% Cloud Waste</strong>
              </span>

              <Link
                to="/products/"
                params={{ slug: "stalciops" }}
                className="inline-flex items-center gap-1.5 text-xs font-bold text-zinc-950 group-hover:text-blue-600 transition-colors"
              >
                <span>View Architecture Specs</span>
                <ArrowUpRight className="h-3.5 w-3.5" />
