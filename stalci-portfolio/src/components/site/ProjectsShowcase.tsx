              ...
              <button
                ...
                className={`relative inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs font-semibold transition-all duration-200 cursor-pointer ${
                  isSelected
                    ...
                    : "bg-white text-slate-700 border border-slate-200 shadow-2xs hover:border-blue-400 hover:text-blue-600"
                }`}
              >
                <span>{cat}</span>
                <span
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((p, idx) => (
            <motion.div
              ...
              className="group relative rounded-3xl bg-gradient-to-b from-white via-slate-50/50 to-slate-100/30 border border-slate-200/90 p-5 sm:p-6 shadow-sm hover:border-blue-500/40 hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col justify-between overflow-hidden hover:-translate-y-1"
            >
              ...
              <div>
                ...
                <div className="relative h-48 w-full rounded-2xl overflow-hidden bg-slate-900 border border-slate-200 shadow-inner">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-3 py-1 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider bg-white/95 text-blue-700 border border-blue-200 backdrop-blur-md shadow-md">
                      {p.category}
                    </span>
                  </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200/80 flex items-center justify-between">
                <span className="text-xs font-bold text-slate-900 group-hover:text-blue-600 flex items-center gap-1.5 transition-colors">
                  <span>View Case Study</span>
                  <ChevronRight className="h-3.5 w-3.5 text-blue-600 group-hover:translate-x-1 transition-transform" />
                </span>

                <div className="flex items-center gap-1.5 text-[11px] font-mono bg-blue-50 text-blue-800 border border-blue-200 px-2.5 py-0.5 rounded-md font-semibold">
